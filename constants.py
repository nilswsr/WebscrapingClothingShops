...
ZA_C_PRICE = 'uqkIZw'
ZA_C_IMGLST = 'XLgdq7'
ZA_C_COLORLST = 'okmnKS'
ZA_C_COLOR = 'dgII7d'
ZA_C_IMG = '_6uf91T'
ZA_C_INFOMAIN = 'y4Yt_f'
ZA_C_INFOSUB = 'OXMl2N'
ZA_C_INFOROW = 'u-6V88'
ZA_ID_REVIEW = 'z-pdp-reviews'
ZA_C_RATING = 'pVrzNP'
...
PREOWNED_KEYWORDS = ["Pre-owned", "Seconde main", "Segunda mano"]

# HM CONSTANTS
HM_C_TITLE = 'product-item-headline'
HM_C_COLOR = 'product-input-label'
...
CURRENCIES = {'AD': 'EUR', 'AE': 'AED', 'AF': 'AFN', 'AG': 'XCD', 'AI': 'XCD', 'AL': 'ALL', 'AM': 'AMD', 'AO': 'AOA',
              ...
              'BT': 'BTN', 'BV': 'NOK', 'BW': 'BWP', 'BY': 'BYR', 'BZ': 'BZD', 'CA': 'CAD', 'CC': 'AUD', 'CD': 'CDF',
              ...
              'HN': 'HNL', 'HR': 'HRK', 'HT': 'HTG', 'HU': 'HUF', 'ID': 'IDR', 'IE': 'EUR', 'IL': 'ILS', 'IM': 'GBP',
              ...
              'ML': 'XOF', 'MM': 'MMK', 'MN': 'MNT', 'MO': 'MOP', 'MP': 'USD', 'MQ': 'EUR', 'MR': 'MRO', 'MS': 'XCD',
              ...
              'SJ': 'NOK', 'SK': 'EUR', 'SL': 'SLL', 'SM': 'EUR', 'SN': 'XOF', 'SO': 'SOS', 'SR': 'SRD', 'SS': 'SSP',
              'ST': 'STD', 'SV': 'USD', 'SX': 'ANG', 'SY': 'SYP', 'SZ': 'SZL', 'TC': 'USD', 'TD': 'XAF', 'TF': 'EUR',
              'TG': 'XOF', 'TH': 'THB', 'TJ': 'TJS', 'TK': 'NZD', 'TL': 'USD', 'TM': 'TMT', 'TN': 'TND', 'TO': 'TOP',
              'TR': 'TRY', 'TT': 'TTD', 'TV': 'AUD', 'TW': 'TWD', 'TZ': 'TZS', 'UA': 'UAH', 'UG': 'UGX', 'UM': 'USD',
              'US': 'USD', 'UY': 'UYU', 'UZ': 'UZS', 'VA': 'EUR', 'VC': 'XCD', 'VE': 'VEF', 'VG': 'USD', 'VI': 'USD',
