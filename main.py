import json
from clothing import ZalandoScraping, HMScraping, ASOSScraping
...
asos_item = ASOSScraping("https://www.asos.com/de/river-island/river-island-spray-on-jeans-mit-zierrissen-in-wei/prd/22243360?clr=wei&colourwayid=60384154&cid=4208")
asos_data = asos_item.get_data()
asos_json = json.dumps(asos_data, indent=2, ensure_ascii=False)
print(asos_json)